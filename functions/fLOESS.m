...
for i = 1:n
    ...
    XX =   [mean(w_.*x_.^0, 'omitnan'), mean(w_.*x_.^1, 'omitnan'), mean(w_.*x_.^2, 'omitnan');...
            mean(w_.*x_.^1, 'omitnan'), mean(w_.*x_.^2, 'omitnan'), mean(w_.*x_.^3, 'omitnan');...
            mean(w_.*x_.^2, 'omitnan'), mean(w_.*x_.^3, 'omitnan'), mean(w_.*x_.^4, 'omitnan')];
    
    YY =   [mean(w_.*y_.*(x_.^0), 'omitnan');...
            mean(w_.*y_.*(x_.^1), 'omitnan');...
            mean(w_.*y_.*(x_.^2), 'omitnan')];
    
    CC = XX\YY; % just normal OLS
