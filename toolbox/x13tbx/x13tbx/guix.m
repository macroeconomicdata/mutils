...
%% *** finalize appearance of GUI *****************************************
    ...
    AllHandles = [hGUI, hpbDocX13, hpbDocTBX, htxtVARIABLE, htxtX13, ... 
        ...
        hpuPrintTable, hchkW, hchkS, hchkQ, hpuXtype, htglOut, hpuOut, ...
        hpbCopy, htxtTimeOfRun, hedOut, haxOut, hslFrom, hslTo]; 
...
%% *** button callbacks **************************************************
    ...
    function pushOpenDoc(hObject,~)
        ...
        switch hObject.String
            ...
            case 'Doc X-11'; docfile = fullfile(docfolder,'Emanual.pdf');
    ...
    function MakeOutput()
        ...
        if htglOut.Value
            ...
            switch out
                ...
                case 'forecast'
                        vrbl = {x.keyv.dat,x.keyv.sa,x.keyv.tr,'fcst','bcst'};
